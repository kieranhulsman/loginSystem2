if __name__ == '__main__': 
    ...
    wb = load_workbook("Login System/User Database.xlsx")
    sheet1 = wb.active
    ...
    def account_info(greeting, first_name, last_name, email, password, is_email_body):
        if is_email_body:
            ...
            print(
                ...
                \n\tNAME: {} {} \
                \n\tEMAIL: {} \
                \n\tPASSWORD: {}".format(name_reformat(greeting), first_name, first_name, last_name, email, password)
                )


    def send_email(user_email, body, header):
        email_authentication_errors_file = open("Login System\emailAuthenticationErrors.txt", "w")
        try: 
            port = 465
                ...
                while not valid_password_login and not out_of_password_attempts:
                    ...
                    if password_login == sheet1["D{}".format(str(row_number))].value:
                        ...
                        if wants_edit_profile:
                            ...
                            edited_user_object = User(
                                edited_full_name_value[0],
                                edited_full_name_value[1],
                                edited_email,
                                edited_password
                                )
                            edited_user_attributes = [
                                edited_user_object.first_name,
    ...
    if has_account:
        ...
        if wants_account:
            ...
            print("\nOkay then. Have a great day!")
    wb.save("Login System/User Database.xlsx")
else:
